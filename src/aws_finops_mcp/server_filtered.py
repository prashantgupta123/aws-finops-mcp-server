"""AWS FinOps MCP Server with category-based tool filtering."""
...
from .tool_categories import is_tool_enabled
from .tools import (
...
ENABLED_CATEGORIES = os.getenv("MCP_TOOL_CATEGORIES", "all")
logger.info(f"MCP Tool Categories: {ENABLED_CATEGORIES}")
...
def register_tool(tool_name: str):
    """Decorator to conditionally register tools based on enabled categories."""
    def decorator(func):
        if is_tool_enabled(tool_name, ENABLED_CATEGORIES):
...
@register_tool("find_unused_lambda_functions")
...
@register_tool("find_unused_elastic_ips")
...
@register_tool("find_unused_amis")
...
@register_tool("find_unused_load_balancers")
...
@register_tool("find_unused_target_groups")
...
@register_tool("find_unused_log_groups")
...
@register_tool("find_unused_snapshots")
...
@register_tool("find_unused_security_groups")
...
@register_tool("find_unused_volumes")
...
@register_tool("find_underutilized_ec2_instances")
...
@register_tool("find_overutilized_ec2_instances")
...
@register_tool("find_underutilized_rds_instances")
...
@register_tool("find_overutilized_rds_instances")
...
@register_tool("get_all_cost_optimization_recommendations")
...
@register_tool("get_cost_optimization_ec2")
...
@register_tool("get_cost_optimization_lambda")
...
@register_tool("get_cost_optimization_rds")
...
@register_tool("get_cost_optimization_ebs")
...
@register_tool("find_target_groups_with_high_error_rate")
...
@register_tool("find_target_groups_with_high_response_time")
...
@register_tool("get_cost_by_region")
...
@register_tool("get_cost_by_service")
...
@register_tool("get_cost_by_region_and_service")
...
@register_tool("get_daily_cost_trend")
...
@register_tool("find_asgs_with_old_amis")
...
@register_tool("find_unused_nat_gateways")
...
@register_tool("find_unused_vpc_endpoints")
...
@register_tool("find_unused_internet_gateways")
...
@register_tool("find_unused_cloudfront_distributions")
...
@register_tool("find_unused_route53_hosted_zones")
...
@register_tool("find_unused_s3_buckets")
...
@register_tool("get_s3_storage_class_recommendations")
...
@register_tool("find_old_ecs_task_definitions")
...
@register_tool("find_unused_ecr_images")
...
@register_tool("find_unused_launch_templates")
...
@register_tool("find_unused_ecs_clusters_and_services")
...
@register_tool("find_unused_sqs_queues")
...
@register_tool("find_unused_sns_topics")
...
@register_tool("find_unused_eventbridge_rules")
...
@register_tool("find_unused_dynamodb_tables")
...
@register_tool("find_underutilized_dynamodb_tables")
...
@register_tool("find_unused_cloudwatch_alarms")
...
@register_tool("find_orphaned_cloudwatch_dashboards")
...
@register_tool("find_orphaned_cloudwatch_alarms")
...
@register_tool("find_overutilized_dynamodb_tables")
...
@register_tool("find_underutilized_elasticache_clusters")
...
@register_tool("find_overutilized_elasticache_clusters")
...
@register_tool("find_underutilized_ecs_services")
...
@register_tool("find_underutilized_lambda_functions")
...
@register_tool("get_savings_plans_recommendations")
...
@register_tool("get_reserved_instance_recommendations")
...
@register_tool("analyze_reserved_instance_utilization")
...
@register_tool("get_ebs_volume_type_recommendations")
...
@register_tool("get_snapshot_lifecycle_recommendations")
...
@register_tool("analyze_data_transfer_costs")
...
@register_tool("get_nat_gateway_optimization_recommendations")
...
@register_tool("find_outdated_rds_engine_versions")
...
@register_tool("find_outdated_elasticache_engine_versions")
...
@register_tool("find_outdated_lambda_runtimes")
...
@register_tool("find_ec2_instances_with_old_generations")
...
@register_tool("find_ebs_volumes_with_old_types")
...
@register_tool("find_outdated_ecs_platform_versions")
...
@register_tool("find_outdated_eks_cluster_versions")
...
@register_tool("analyze_lambda_cold_starts")
...
@register_tool("analyze_api_gateway_performance")
...
@register_tool("analyze_dynamodb_throttling")
...
@register_tool("analyze_rds_performance_insights")
...
@register_tool("analyze_cloudfront_cache_hit_ratio")
...
@register_tool("find_unencrypted_ebs_volumes")
...
@register_tool("find_unencrypted_s3_buckets")
...
@register_tool("find_unencrypted_rds_instances")
...
@register_tool("find_public_s3_buckets")
...
@register_tool("find_overly_permissive_security_groups")
...
@register_tool("find_untagged_resources")
...
@register_tool("analyze_tag_compliance")
...
@register_tool("generate_cost_allocation_report")
